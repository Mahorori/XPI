...
enum OFFTYPE { OFF_NONE = 0, OFF_ADD, OFF_SUB };
...
const MAPLE_HOOK MapleHooks[] =
{
	...
	{ SendPacket,		{ L"CClientSocket::SendPacket",		&_SendPacket,		OFF_SUB,	43,		L"64 A3 00 00 00 00 89 8D ?? ?? FF FF 6A 00 E9" } },
	// recv functions
	{ Decode1,			{ L"CInPacket::Decode1",			&_Decode1,			OFF_SUB,	64,		L"83 F8 01 73 3F" } },
	{ Decode2,			{ L"CInPacket::Decode2",			&_Decode2,			OFF_SUB,	64,		L"83 F8 02 73 3F" } },
	{ Decode4,			{ L"CInPacket::Decode4",			&_Decode4,			OFF_SUB,	64,		L"83 F8 04 73 3F" } },
	{ Decode8,			{ L"CInPacket::Decode8",			&_Decode8,			OFF_SUB,	64,		L"83 F8 08 73 3F" } },
	...
	{ ProcessPacket,	{ L"CClientSocket::ProcessPacket",	&_ProcessPacket,	OFF_SUB,	65,		L"8B 7C 24 2C 8B CF C7 44 24 24 00 00 00 00 E8" } },
